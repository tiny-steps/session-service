...
public class SessionOfferingController {
    ...
    public ResponseEntity<SessionOffering> create(@RequestBody SessionOffering offering) {
        // Branch validation is now handled by BranchValidationFilter
        return ResponseEntity.ok(service.create(offering));
    }
    ...
    public ResponseEntity<Page<SessionOffering>> search(
        ...
        // Branch validation is now handled by BranchValidationFilter
        return ResponseEntity.ok(service.search(sessionTypeId, isActive, minPrice, maxPrice, branchId, pageable));
    }
    ...
    public ResponseEntity<Page<SessionOffering>> getSessionOfferingsForCurrentUserBranch(
        ...
        return ResponseEntity
                .ok(service.searchForCurrentUserBranch(sessionTypeId, isActive, minPrice, maxPrice, pageable));
    }
